#ifndef ZXNNLS_SOLVER_H
#define ZXNNLS_SOLVER_H
...
{
public:
    zxNNLS_SOLVER(int rows, int maxCols) :
        _rows( rows ),
        _maxCols( maxCols )
    {
    _workA = NULL;
    ...
    cout << " Warning: this version of nnls solve will destroy the A matrix. Use with caution!!!" << endl;
    }
